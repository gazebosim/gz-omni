...
class OmniverseMaterial : public Material {
 public:
  ...
  void SetAmbient(const double _r, const double _g, const double _b,
  ...
  void SetSpecular(const double _r, const double _g, const double _b,
                   const double _a = 1.0) override;
  ...
  void SetAlphaFromTexture(bool _enabled, double _alpha = 0.5,
                           bool _twoSided = true) override;
