...
{
  bool OmniverseMesh::HasSkeleton() const { throw std::runtime_error("not implemented"); }
  std::map<std::string, math::Matrix4d> OmniverseMesh::SkeletonLocalTransforms() const { throw std::runtime_error("not implemented"); }
  ...
  bool OmniverseMesh::HasSubMesh(ConstSubMeshPtr _subMesh) const { throw std::runtime_error("not implemented"); }
  bool OmniverseMesh::HasSubMeshName(const std::string &_name) const { throw std::runtime_error("not implemented"); }
  SubMeshPtr OmniverseMesh::SubMeshByName(const std::string &_name) const { throw std::runtime_error("not implemented"); }
  SubMeshPtr OmniverseMesh::SubMeshByIndex(unsigned int _index) const { throw std::runtime_error("not implemented"); }
  void OmniverseMesh::SetDescriptor(const MeshDescriptor &_desc) { throw std::runtime_error("not implemented"); }
